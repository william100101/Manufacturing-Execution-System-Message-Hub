...
namespace MessageHub.VerticalAnnealingModels
{
    public partial class VerticalAnnealingContext : DbContext
    {
        public VerticalAnnealingContext()
        {
        }

        public VerticalAnnealingContext(DbContextOptions<VerticalAnnealingContext> options)
            : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.HasSequence<int>("LINE_SEQUENCE_GROUPKEY_SEQ", "Runtime")
                .StartsAt(176)
                .HasMin(1);
