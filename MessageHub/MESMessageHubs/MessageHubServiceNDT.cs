...
namespace MessageHub
{
    ...
    public class MessageHubServiceNDT
    {
        private IDbContextFactory<NDTContext> _contextFactoryNDT { get; set; } 

        public MasterDataModel MasterData { get; set; }

        public MessageHubServiceNDT(IDbContextFactory<NDTContext> contextFactory)
        {
            _contextFactoryNDT = contextFactory;
            MasterData = GetMasterDataNDT();
        }

        private MasterDataModel GetMasterDataNDT()
        {
            var masterData = new MasterDataModel();
            masterData.MessageStates = GetMessageStatesNDT();

            masterData.Interfaces = GetInterfacesNDT();

            return masterData;
        }


        private List<TargetSystem> GetTargetSystemsNDT()
        {
            using (var context = _contextFactoryNDT.CreateDbContext())
            {
        ...
        private List<MessageState> GetMessageStatesNDT()
        {
            using (var context = _contextFactoryNDT.CreateDbContext())
            {
        ...
        public List<NDTModels.ToBiz> GetLatestToBiz(string messageName, DateTime StartDate, DateTime EndDate, string searchCondition = "")
        {
            using (var context = _contextFactoryNDT.CreateDbContext())
            {
                string sql = "";
        ...
        public List<NDTModels.FromBiz> GetLatestFromBiz(string messageName, DateTime StartDate, DateTime EndDate, string searchCondition = "")
        {
            using (var context = _contextFactoryNDT.CreateDbContext())
            {
                string sql = "";
        ...
        private List<InterfaceTarget> GetInterfaceTargetsNDT()
        {
            using (var context = _contextFactoryNDT.CreateDbContext())
            {
                var distinctRowsToBiz = context.ToBizs
        ...
        public List<NDTModels.FromBiz> GetAcksReading(List<string> transactionIds) 
        {
        ...
        public List<NDTModels.FromBiz> GetAcknowledgementsFromBizOnly()
        {
            List<NDTModels.FromBiz> acknowledgements = new List<NDTModels.FromBiz>();
            using (var context = _contextFactoryNDT.CreateDbContext())
            {
                var query = from x in context.FromBizs
                            where x.MessageName == "MessageAcknowledgement"
        ...
        public List<NDTModels.FromBiz> GetStatusesFromBizOnly()
        {
            List<NDTModels.FromBiz> acknowledgements = new List<NDTModels.FromBiz>();
            using (var context = _contextFactoryNDT.CreateDbContext())
            {
        ...
        public List<NDTModels.FromBiz> GetStatusesReading(List<string> transactionIds) 
        {
            for (int i = 0; i < transactionIds.Count - 1; i++)
            {
                transactionIds[i] = transactionIds[i].TrimStart('0');
        ...
        public NDTModels.FromBiz GetFromBizById(int Id)
        {
            using (var context = _contextFactoryNDT.CreateDbContext())
            {
                var query = from x in context.FromBizs
        ...
        public NDTModels.ToBiz GetToBizById(int Id)
        {
            using (var context = _contextFactoryNDT.CreateDbContext())
            {
        ...
        public List<Interface> GetInterfacesNDT()
        {
        ...
        public List<AckStatusReciver> GetStatusAndAck(int id)
        {
            ...
            using (var connection = _contextFactoryNDT.CreateDbContext().Database.GetDbConnection())
            {
                connection.Open();
