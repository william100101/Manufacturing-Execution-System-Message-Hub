...
{
    public class MessageHubServiceWetGrinder
    {
        private IDbContextFactory<WetGrinderContext> contextFactoryWetGrinder { get; set; }

        public MasterDataModel MasterData { get; set; }

        public MessageHubServiceWetGrinder(IDbContextFactory<WetGrinderContext> contextFactory)
        {
            contextFactoryWetGrinder = contextFactory;
            MasterData = GetMasterDataWetGrinder();
        }

        private MasterDataModel GetMasterDataWetGrinder()
        {
            var masterData = new MasterDataModel();
            masterData.MessageStates = GetMessageStatesWetGrinder();

            masterData.Interfaces = GetInterfacesWetGrinder();

            return masterData;
        }


        private List<TargetSystem> GetTargetSystemsWetGrinder() 
        {

            using (var context = contextFactoryWetGrinder.CreateDbContext())
            {
        ...
        private List<MessageState> GetMessageStatesWetGrinder()
        {
            using (var context = contextFactoryWetGrinder.CreateDbContext())
            {
        ...
        public List<Interface> GetInterfacesWetGrinder()
        {
        ...
        public List<WetGrinderModels.ToBiz> GetLatestToBiz(string messageName, DateTime StartDate, DateTime EndDate, string searchCondition = "")
        {
            using (var context = contextFactoryWetGrinder.CreateDbContext())
            {
                string sql = "";
        ...
        public List<WetGrinderModels.FromBiz> GetLatestFromBiz(string messageName, DateTime StartDate, DateTime EndDate, string searchCondition = "")
        {
            using (var context = contextFactoryWetGrinder.CreateDbContext())
            {
                string sql = "";
        ...
        public List<WetGrinderModels.FromBiz> GetAcksReading(List<string> transactionIds)
        {
        ...
        public List<WetGrinderModels.FromBiz> GetAcknowledgementsFromBizOnly()
        {
            List<WetGrinderModels.FromBiz> acknowledgements = new List<WetGrinderModels.FromBiz>();
            using (var context = contextFactoryWetGrinder.CreateDbContext())
            {
                var query = from x in context.FromBizs
                            where x.MessageName == "MessageAcknowledgement"
        ...
        public List<WetGrinderModels.FromBiz> GetStatusesFromBizOnly()
        {
            List<WetGrinderModels.FromBiz> acknowledgements = new List<WetGrinderModels.FromBiz>();
            using (var context = contextFactoryWetGrinder.CreateDbContext())
            {
        ...
        public List<WetGrinderModels.FromBiz> GetStatusesReading(List<string> transactionIds) 
        {
            for (int i = 0; i < transactionIds.Count - 1; i++)
            {
                transactionIds[i] = transactionIds[i].TrimStart('0');
        ...
        public WetGrinderModels.FromBiz GetFromBizById(int Id)
        {
            using (var context = contextFactoryWetGrinder.CreateDbContext())
            {
                var query = from x in context.FromBizs
        ...
        public WetGrinderModels.ToBiz GetToBizById(int Id)
        {
            using (var context = contextFactoryWetGrinder.CreateDbContext())
            {
        ...
        public List<AckStatusReciver> GetStatusAndAck(int id)
        {
            ...
            using (var connection = contextFactoryWetGrinder.CreateDbContext().Database.GetDbConnection())
            {
                connection.Open();
