...
namespace MessageHub
{
    ...
    public class MessageHubServiceESR
    {
        private IDbContextFactory<ESRContext> _contextFactoryESR { get; set; }

        public MasterDataModel MasterData { get; set; }

        public MessageHubServiceESR(IDbContextFactory<ESRContext> contextFactory)
        {
            _contextFactoryESR = contextFactory;
            MasterData = GetMasterDataESR();
        }

        private MasterDataModel GetMasterDataESR()
        {
            var masterData = new MasterDataModel();
            masterData.MessageStates = GetMessageStatesESR();

            masterData.TargetSystems = GetTargetSystemsESR();

            masterData.InterfaceTargets = GetInterfaceTargetsESR();

            masterData.Interfaces = GetInterfacesESR();

            return masterData;
        }


        private List<TargetSystem> GetTargetSystemsESR()
        {
            using (var context = _contextFactoryESR.CreateDbContext())
            {
                var query = from tp in context.BizCorrespondents
                            select tp;
                return query.ToList().GetInterfaceTargetESR();
            }
        }

        private List<MessageState> GetMessageStatesESR()
        {
            using (var context = _contextFactoryESR.CreateDbContext())
            {
        ...
        public List<ESRModels.ToBiz> GetLatestToBiz(string messageName, DateTime StartDate, DateTime EndDate, string searchCondition = "")
        {
            using (var context = _contextFactoryESR.CreateDbContext())
            {
                string sql = "";
        ...
        public List<ESRModels.FromBiz> GetLatestFromBiz(string messageName, DateTime StartDate, DateTime EndDate, string searchCondition = "")
        {
            using (var context = _contextFactoryESR.CreateDbContext())
            {
                string sql = "";
        ...
        private List<InterfaceTarget> GetInterfaceTargetsESR()
        {
            ...
            using (var context = _contextFactoryESR.CreateDbContext())
            {
                ...
                var interfaceTargetListToBizs = distinctRowsToBiz
                    ...
                    .Select(x => new InterfaceTarget
                    {
                        ...
                        Distribution = "WChoi@cartech.com",
                        ErrorMessageCapable = true,
                        TargetSystemID = x.DestinationId,
        ...
        public List<ESRModels.FromBiz> GetAcksReading(List<string> transactionIds)
        {
        ...
        public List<ESRModels.FromBiz> GetAcknowledgementsFromBizOnly()
        {
            List<ESRModels.FromBiz> acknowledgements = new List<ESRModels.FromBiz>();
            using (var context = _contextFactoryESR.CreateDbContext())
            {
                var query = from x in context.FromBizs
                            where x.MessageName == "MessageAcknowledgement"
        ...
        public List<ESRModels.FromBiz> GetStatusesFromBizOnly()
        {
            List<ESRModels.FromBiz> acknowledgements = new List<ESRModels.FromBiz>();
            using (var context = _contextFactoryESR.CreateDbContext())
            {
        ...
        public List<ESRModels.FromBiz> GetStatusesReading(List<string> transactionIds)
        {
            for (int i = 0; i < transactionIds.Count - 1; i++)
            {
                transactionIds[i] = transactionIds[i].TrimStart('0');
        ...
        public bool ResetFromBizStatus(int FromBizId, string ResubmitUserId, string PrevErrorDescription)
        {
            ...
            using (var context = _contextFactoryESR.CreateDbContext())
            {
                ...
                //record.ResubmitUseridId = ResubmitUserId;
        ...
        public ESRModels.FromBiz GetFromBizById(int Id)
        {
            using (var context = _contextFactoryESR.CreateDbContext())
            {
                var query = from x in context.FromBizs
        ...
        public ESRModels.ToBiz GetToBizById(int Id)
        {
            using (var context = _contextFactoryESR.CreateDbContext())
            {
        ...
        private bool EditOriginalFromBiz(InterfaceMessageModel message, string newXML)
        {
            ...
            using (var context = _contextFactoryESR.CreateDbContext())
            {
                ...
                //existing.ResubmitUseridId = message.ResubmitUserId;
        ...
        public List<Interface> GetInterfacesESR()
        {
        ...
        public List<AckStatusReciver> GetStatusAndAck(int id)
        {
            ...
            using (var connection = _contextFactoryESR.CreateDbContext().Database.GetDbConnection())
            {
                connection.Open();
